...
<nav class="w3-sidebar w3-black w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="http://localhost:9090/javaProjectS12"  class="w3-bar-item w3-button w3-hover-white">홈</a> 
    <a href="${ctp}/admin/adminProduct" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">상품등록</a> 
    <a href="${ctp}/admin/adminFeatures" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">FEATURES</a> 
    <a href="#designers" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">문의사항</a> 
